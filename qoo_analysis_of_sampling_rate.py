...
def run_qoo_stability_analysis(input_folder, nrp, nrpou, original_frequency=1000, sub_frequencies=[10, 50, 100], iterations=10, output_file="qoo_stability_analysis.png", simulation_time=900):
